...
const LINKS = [
  { label: 'GitHub (Front)', href: 'https://github.com/dlfakxm122133/sst-react' },
  { label: 'GitHub (Back)', href: 'https://github.com/dlfakxm122133/sst-backend' },
  { label: 'GitHub (FastAPI)', href: 'https://github.com/dlfakxm122133/sst-fastApi' },
